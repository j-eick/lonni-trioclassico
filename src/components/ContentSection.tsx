    ...
    return (
        ...
        >
            <div className="relative z-10 max-w-6xl w-full mx-auto">
                ...
                <div className="absolute -z-10 inset-0 bg-gradient-to-tr from-luxury-gold/[0.06] to-transparent rounded-lg" />
                {/* Main Content */}
                <div className="relative bg-white/[0.02] backdrop-blur-md p-8 md:p-16 shadow-elegant border border-white/[0.06] rounded-lg group">
                    {/* Inner Glow */}
